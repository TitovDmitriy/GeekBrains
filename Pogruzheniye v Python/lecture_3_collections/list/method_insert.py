...
# добавленного элемента будет находиться ещё два. В том случае, когда индекс оказывается больше,
# чем количество элементов списка, объект добавляется в конец. В таком случае логичнее использовать метод append,
