...
# пробельным символам. Три переменные до знака равно примут по одному из переданных значений.
# 🔥 Важно! С одной стороны удобно запросить у пользователя три значения
# в одной строке кода. Но стоит пользователю ошибиться с пробелами и ввести
...
print(a, b, c)
# Переменная подчёркивание, благодаря звёздочке - символу упаковки, превращается в список,
# который заберет значения начиная с четвёртого.
