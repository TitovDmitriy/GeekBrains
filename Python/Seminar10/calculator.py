...
keyboard.row(   telebot.types.InlineKeyboardButton('j', callback_data='j'),
                ...
                telebot.types.InlineKeyboardButton('sin complex', callback_data='sin complex'),
                telebot.types.InlineKeyboardButton('cos complex', callback_data='cos complex'))
...
def callback_func(query):
    ...
    elif data == "sin complex":
        value = str(cmath.sin(complex(value)))
    elif data == "cos complex":
        value = str(cmath.cos(complex(value)))
    elif data == '=':
        try:
